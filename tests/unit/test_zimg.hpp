...
void unit_test_zimg_header_integrity()
{
    ...
    K_T_ASSERT(sizeof(ZImgHeader) == 40, "ZImgHeader size mismatch! Should be 40 bytes");
    ...
    K_T_ASSERT(entry_point % 16 == 0, "Root Entry Point must be 16-byte aligned");
...
void unit_test_compact_pe_loading()
{
    ...
    K_T_ASSERT(final_jump_addr % 16 == 0,
